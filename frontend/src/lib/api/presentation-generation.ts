...
export class PresentationGenerationApi {
  static async uploadDoc(documents: File[]) {
    ...
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/upload`,
        {
          method: "POST",
  ...
  static async decomposeDocuments(documentKeys: string[]) {
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/decompose`,
        {
          method: "POST",
          headers: getHeader(),
          body: JSON.stringify({
  ...
  static async editSlide(
    ...
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/slide/edit`,
        {
          method: "POST",
          headers: getHeader(),
          body: JSON.stringify({
  ...
  static async updatePresentationContent(body: any) {
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/update`,
        {
          method: "PATCH",
          headers: getHeader(),
  ...
  static async presentationPrepare(presentationData: any) {
    try {
      const response = await fetch(
        API_ENDPOINTS.presentations.prepare(),
        {
          method: "POST",
          headers: getHeader(),
  ...
  static async generateImage(imageGenerate: ImageGenerate) {
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/images/generate?prompt=${imageGenerate.prompt}`,
        {
          method: "GET",
          headers: getHeader(),
          cache: "no-cache",
  ...
  static getPreviousGeneratedImages = async (): Promise<PreviousGeneratedImagesResponse[]> => {
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/images/generated`,
        {
          method: "GET",
          headers: getHeader(),
        }
  ...
  static async searchIcons(iconSearch: IconSearch) {
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/icons/search?query=${iconSearch.query}&limit=${iconSearch.limit}`,
        {
          method: "GET",
          headers: getHeader(),
          cache: "no-cache",
  ...
  static async exportAsPPTX(presentationData: any) {
    try {
      const response = await fetch(
        `${API_ENDPOINTS.presentations.create()}/export/pptx`,
        {
          method: "POST",
          headers: getHeader(),
          body: JSON.stringify(presentationData),
